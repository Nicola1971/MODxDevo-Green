...
<head>
	...
	font-family: Arial, Tahoma, Helvetica, sans-serif;height: 100%;color: #6fa5a1;}
    body {font-size: 75%; /* 12px 62.5% for 10px*/margin-bottom: 1px; /* avoid jumping scrollbars */background: #17312f;}
...
padding:8px 0 8px 20px; 
   ...
   .sectionHeaderLogin a,.sectionHeaderLogin a:active,.sectionHeaderLogin a:visited,.sectionHeaderLogin a:link {color: #6fa5a1;text-decoration: none;}
    .sectionBody {padding: 2px 20px 20px;display: block; background: transparent;
	    height: auto !important; 
    height: 270px;     
    min-height: 270px;
}
    #mx_loginbox {background:#1a4a46; background-image:linear-gradient(#26504d,#193432); width: 460px;margin: 30px auto 0; -webkit-border-radius: 3px;
...
border-radius: 3px; }
    ...
    input.text {color:#FFF; width: 400px;background: #0f201e;border:1px solid #214643;padding:6px; 
